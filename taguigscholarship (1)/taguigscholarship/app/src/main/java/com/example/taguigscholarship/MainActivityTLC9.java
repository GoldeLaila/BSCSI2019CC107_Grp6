...
public class MainActivityTLC9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_tlc9);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentt = new Intent(MainActivityTLC9.this, MainActivity3profile.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentt = new Intent(MainActivityTLC9.this, MainActivityTLC8.class);
                startActivity(intentt);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                vali = valid();
                if(vali) {
                    fns = pa.getText().toString();
                    lns = ti.getText().toString();
                    mms = cn.getText().toString();
                    ads = tp.getText().toString();
                    brs = lt.getText().toString();
                    dss = pp.getText().toString();
                    tys = bk.getText().toString();

                    URL = "http://"+Final_IP.IP_ADDRESS+"/isko/tlc9.php";

                    StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, response -> {
                        Log.d("res", response);
                        if (response.equals("success")) {
                            Toast.makeText(MainActivityTLC9.this, "Filled up Successfully.", Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(MainActivityTLC9.this, MainActivity3lani9.class);
                            startActivity(intent);
                            finish();
                        } else if (response.equals("failure")) {
                            Toast.makeText(MainActivityTLC9.this, "Something wrong, try again.", Toast.LENGTH_SHORT).show();
                        }
                    }, error -> Toast.makeText(MainActivityTLC9.this, error.toString().trim(), Toast.LENGTH_SHORT).show()) {
                        @Override
