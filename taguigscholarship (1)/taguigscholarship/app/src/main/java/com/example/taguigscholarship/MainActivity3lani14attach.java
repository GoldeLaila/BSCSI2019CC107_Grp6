...
public class MainActivity3lani14attach extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_activity3lani14attach);
        ...
        nx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intentt = new Intent(MainActivity3lani14attach.this, MainActivity3lani15attach.class);
